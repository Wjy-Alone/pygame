import pygame
import sys
from plane_1 import Plane_1
from plane_2 import Plane_2
...
def run_game():
    ...
    my_plane_1 = Plane_1(screen,my_settings)
    my_plane_2 = Plane_2(screen, my_settings)
    bullets = Group()
    enemy_planes = Group()
    ...
    while True:
        ...
        gf.check_events(my_plane_1,my_plane_2,screen,bullets,my_settings)
        my_plane_1.update()
        my_plane_2.update()
        gf.update_bullets(bullets,enemy_planes,my_settings)
        gf.update_enemy_planes(my_plane_1,my_plane_2,enemy_planes,screen,my_settings,bullets)
        gf.create_enemy_planes(screen, enemy_planes, my_settings)
        gf.update_screen(screen,my_plane_1,my_plane_2,bg_image,my_settings,bullets,enemy_planes,sn,max_score)
